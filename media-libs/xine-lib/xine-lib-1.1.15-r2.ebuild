...
# $Header: /var/cvsroot/gentoo-x86/media-libs/xine-lib/Attic/xine-lib-1.1.15-r1.ebuild,v 1.13 2009/04/15 18:55:31 aballier dead $
...
src_unpack() {
	...
	sed -i "s/PIX_FMT_RGBA32/PIX_FMT_RGB32/g" src/combined/ffmpeg/ff_video_decoder.c
}
