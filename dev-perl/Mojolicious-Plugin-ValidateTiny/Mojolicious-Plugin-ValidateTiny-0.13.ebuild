...
MODULE_AUTHOR="KOORCHIK"


inherit perl-module

DESCRIPTION="Lightweight validator for Mojolicious"
...
DEPEND=">=dev-perl/Validate-Tiny-0.984
	>=dev-perl/Mojolicious-3.940.0
	dev-lang/perl"


src_install() {
		perl-module_src_install
		find "${D}" -type f -name README.pod -delete
}
