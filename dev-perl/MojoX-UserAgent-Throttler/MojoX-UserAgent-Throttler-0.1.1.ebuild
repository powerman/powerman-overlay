...
DESCRIPTION="add throttling support to Mojo::UserAgent"
...
DEPEND=">=dev-perl/Mojolicious-5.410
	>=dev-perl/Sub-Throttler-0.2.0
	>=virtual/perl-Scalar-List-Utils-1.400.0
	>=dev-perl/Test-CheckManifest-0.9
	dev-perl/Test-Perl-Critic
	>=dev-perl/Test-Pod-1.220.0
	>=dev-perl/Test-Pod-Coverage-1.80.0
	>=dev-perl/Pod-Coverage-0.180.0
	dev-lang/perl"
