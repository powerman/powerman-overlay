...
SRC_URI="http://www.vitanuova.com/dist/4e/inferno-20100120.tgz
	...
	http://inferno-re2.googlecode.com/files/inferno-re2-1.0.1.tgz
	"
...
src_unpack() {
	...
	if use re2; then
		unpack "inferno-re2-1.0.1.tgz"
		epatch "re2wrap.patch"
	fi

	epatch "${FILESDIR}/issue-122-csendalt.patch"
	epatch "${FILESDIR}/issue-147-wait.patch"
	epatch "${FILESDIR}/issue-244-devsrv.patch"
	epatch "${FILESDIR}/issue-244-man3srv.patch"
